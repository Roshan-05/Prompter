      ...
      <nav className="nav mx-10 mt-5">
        ...
        >
          <Link href="/" className="flex gap-2">
            <Image
              src={isMenuClicked ? "/assets/icons/circle-x.svg" : "/assets/icons/paper-plane.svg"}
              width={24}
              height={5}
              alt="Prompter Logo"
            />
            <p className="p-2 text-base font-bold">Menu</p>
          </Link>
        </div>
...
{/* conditionally renders the login button */}
<div>
{session?.user ? (
          <div className="flex">
            <Image
          ...
          <>
          <Link href="/login">
              <button className="white_btn px-5 py-2 font-semibold">
                Log In
              </button>
            </Link>
          </>
